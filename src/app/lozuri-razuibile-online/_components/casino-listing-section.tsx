...
export function CasinoListingSection() {
  ...
  return (
    <section id="cazinouri" className="py-14 lg:py-20">
      <div className="container mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div className="mb-8 text-center">
          <div className="w-10 h-1 bg-orange-500 rounded-full mb-4 mx-auto" />
          <h2 className="text-2xl sm:text-3xl font-bold font-mono text-gray-900">
            Top Cazinouri cu Jocuri de Lozuri Răzuibile
          </h2>
          <p className="text-base text-gray-500 mt-2 max-w-2xl mx-auto">
            Am selectat cele mai bune cazinouri internaționale care oferă lozuri răzuibile online de la furnizori
            premium.
          </p>
        </div>
        ...
        <div className="lg:hidden space-y-3">
          {casinos.map((casino, i) => {
            ...
            return (
              ...
              >
                {rank === 1 && <div className="h-1 bg-gradient-to-r from-orange-500 to-orange-400" />}
                ...
                <div className="p-4 space-y-4">
                  ...
                  <div className="flex items-center gap-3">
                    <span
                      className={`flex h-9 w-9 items-center justify-center rounded-full text-sm font-bold text-white flex-shrink-0 ${
                        rank === 1 ? 'bg-orange-500 shadow-md' : rank <= 3 ? 'bg-orange-400' : 'bg-gray-400'
                      }`}
                    >
                      {rank}
                    </span>
                    ...
                    <div className="min-w-0 flex-1">
                      <p className="text-base font-bold font-mono text-gray-900 truncate">{casino.name}</p>
                  ...
                  <div className="rounded-xl bg-orange-50 border border-orange-100 px-3 py-2.5">
                    <p className="text-sm font-semibold text-orange-700 font-mono leading-snug">{casino.bonusTitle}</p>
                  </div>
                  ...
                  <div className="grid grid-cols-3 gap-2 text-center">
                    <div className="rounded-lg bg-gray-50 py-2 px-1">
                      ...
                      <p className="text-sm font-bold font-mono text-gray-900">{casino.bonusPercentage}%</p>
                    </div>
                    <div className="rounded-lg bg-gray-50 py-2 px-1">
                    ...
                    <div className="rounded-lg bg-gray-50 py-2 px-1">
                      ...
                      <p className="text-sm font-bold font-mono text-gray-900">x{casino.wageringRequirement}</p>
                    </div>
                  </div>
                  ...
                  >
                    ...
                    <td className="px-3 py-3">
                      <span className="text-[13px] font-semibold text-orange-600 font-mono leading-tight whitespace-nowrap">
                        {casino.bonusPercentage}% până la {casino.bonusMaxAmount.toLocaleString('ro-RO')}{' '}
                        {casino.bonusCurrency}
                      </span>
                    </td>
