      ...
      <div className="container mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div className="mb-10 text-center">
          ...
          <h2 className="text-2xl sm:text-3xl font-bold font-mono text-gray-900">
            Cerințe de Rulaj și Condiții Bonus Megapari
          </h2>
        ...
        <div className="grid gap-6 lg:grid-cols-2 mb-8">
          ...
          <div className="rounded-2xl border-2 border-orange-200 bg-white p-6 shadow-sm">
            ...
            <div className="space-y-3">
              ...
              <div className="flex items-start gap-2">
                <CheckCircle2 className="h-5 w-5 text-green-600 flex-shrink-0 mt-0.5" />
                <span className="text-sm text-gray-700">Valabil 7 zile de la activare</span>
              </div>
              <div className="flex items-start gap-2">
                <CheckCircle2 className="h-5 w-5 text-green-600 flex-shrink-0 mt-0.5" />
          ...
          <div className="rounded-2xl border-2 border-green-200 bg-white p-6 shadow-sm">
            ...
            <div className="rounded-xl bg-green-50 p-5 text-center mb-5">
              <p className="text-5xl font-extrabold text-green-600 font-mono">20x</p>
            ...
            <div className="space-y-3">
              <div className="flex items-start gap-2">
                <CheckCircle2 className="h-5 w-5 text-green-600 flex-shrink-0 mt-0.5" />
                <span className="text-sm text-gray-700">Rulaj mai mic decât standard</span>
              </div>
              <div className="flex items-start gap-2">
                <CheckCircle2 className="h-5 w-5 text-green-600 flex-shrink-0 mt-0.5" />
                <span className="text-sm text-gray-700">Cod promoțional: ROTIRI</span>
              </div>
              <div className="flex items-start gap-2">
                <CheckCircle2 className="h-5 w-5 text-green-600 flex-shrink-0 mt-0.5" />
                <span className="text-sm text-gray-700">Valabil 7 zile</span>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="rounded-2xl border border-gray-200 bg-white p-6 shadow-sm mb-6">
          ...
          <div className="grid gap-4 sm:grid-cols-3 text-center">
            <div className="rounded-xl bg-gray-50 p-4">
              ...
              <p className="text-xl font-bold text-gray-900 font-mono">500 EUR</p>
            </div>
            <div className="rounded-xl bg-orange-50 p-4">
              <p className="text-xs text-gray-500 uppercase mb-1">Bonus 100%</p>
              <p className="text-xl font-bold text-orange-600 font-mono">500 EUR</p>
            </div>
            <div className="rounded-xl bg-green-50 p-4">
              <p className="text-xs text-gray-500 uppercase mb-1">Rulaj necesar (35x)</p>
              <p className="text-xl font-bold text-green-600 font-mono">17.500 EUR</p>
            </div>
          </div>
        </div>
        ...
        <div className="rounded-xl border border-red-200 bg-red-50/50 p-5 text-center">
          <div className="flex items-center justify-center gap-2 mb-2">
            ...
            <span className="font-mono font-bold text-red-700">Atenție Importantă</span>
          </div>
          <p className="text-sm text-gray-700 leading-relaxed">
            Depunerile efectuate cu <strong>criptomonede</strong> (Bitcoin, Ethereum etc.) <strong>NU sunt eligibile</strong>{' '}
            pentru bonusurile de bun venit. Folosește carduri bancare sau portofele electronice pentru a activa bonusul.
          </p>
        </div>
      </div>
    </section>
