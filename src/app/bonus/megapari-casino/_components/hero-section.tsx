      ...
      <div className="container mx-auto max-w-7xl py-12 sm:py-16 lg:py-20 px-4 sm:px-6 lg:px-8 text-center">
        ...
        <nav aria-label="Breadcrumb" className="mb-6">
          <ol className="flex items-center justify-center gap-1.5 text-sm font-mono text-gray-400">
            ...
            <li>/</li>
            <li className="text-gray-900 font-semibold">Megapari Casino Bonus</li>
          </ol>
        </nav>
        ...
        <h1 className="mb-5 text-3xl font-extrabold tracking-tight text-gray-900 sm:text-4xl lg:text-5xl font-mono leading-[1.1] max-w-4xl mx-auto">
          Bonus <span className="text-orange-500">Megapari Casino</span> 2026
        </h1>

        {/* Intro */}
        <p className="text-base sm:text-lg text-gray-500 leading-relaxed max-w-3xl mx-auto mb-8">
          Megapari Casino oferă unul dintre cele mai generoase pachete de bun venit pentru
          jucătorii români. Include un bonus exclusiv fără depunere, bonusuri la primele depuneri,
          program VIP pe 8 niveluri și acces la peste 20.000 de jocuri de la 200+ furnizori.
        </p>
        ...
        <div className="flex flex-wrap items-center justify-center gap-3 mb-8">
          <div className="flex items-center gap-1.5 rounded-full border border-gray-200 bg-white px-3 py-1.5 shadow-sm">
            ...
            <span className="text-xs font-mono font-semibold text-gray-700">100 Rotiri Fără Depunere</span>
          </div>
          <div className="flex items-center gap-1.5 rounded-full border border-gray-200 bg-white px-3 py-1.5 shadow-sm">
            <TrendingUp className="h-3.5 w-3.5 text-orange-500" />
            <span className="text-xs font-mono font-semibold text-gray-700">200% Bonus</span>
          </div>
          <div className="flex items-center gap-1.5 rounded-full border border-gray-200 bg-white px-3 py-1.5 shadow-sm">
            <Award className="h-3.5 w-3.5 text-amber-500" />
            <span className="text-xs font-mono font-semibold text-gray-700">8 Niveluri VIP</span>
          </div>
        </div>
