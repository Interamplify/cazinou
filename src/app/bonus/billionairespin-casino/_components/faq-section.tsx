...
import { billionaireSpinBonusFaqs } from '@/data/billionairespin-bonus';
      ...
      <div className="container mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div className="mb-8 text-center">
          ...
          <h2 className="text-2xl sm:text-3xl font-bold font-mono text-gray-900">
            &#206;ntreb&#259;ri Frecvente despre Bonusul Billionairespin
          </h2>
          <p className="text-base text-gray-500 mt-2 max-w-2xl mx-auto">
            Răspunsuri la cele mai frecvente întrebări despre bonusurile și promoțiile de la
        ...
        <div className="max-w-2xl mx-auto">
          <Accordion type="single" collapsible className="space-y-3">
            {billionaireSpinBonusFaqs.map((faq, i) => (
              <AccordionItem
                key={i}
                value={`faq-${i}`}
