...
const steps = [
  {
    ...
    desc: 'Confirmă că ai completat 100% din rulaj, nu ai depășit plafonul de câștig și bonusul nu a expirat. Progresul apare de regulă în secțiunea „Cont" sau „Bonus".',
    Icon: CheckCircle,
  },
  {
    step: 2,
    title: 'Completează KYC',
    desc: 'Trimite: buletin/pașaport (ambele fețe), factură de utilități recentă (sub 3 luni), dovadă card/e-wallet. Recomandare: fă verificarea imediat după înregistrare.',
    Icon: FileText,
  },
  {
    step: 3,
    title: 'Solicită Retragerea',
    desc: 'Accesează secțiunea „Casierie" sau „Retrageri": selectează metoda (Skrill, Neteller, crypto sunt cele mai rapide), introdu suma, confirmă tranzacția.',
    Icon: Wallet,
  },
  {
    step: 4,
    title: 'Primește Banii',
    desc: 'Timpul de procesare depinde de metoda aleasă. E-wallet-urile (Skrill, Neteller) și criptomonedele (Bitcoin) oferă cele mai scurte timpi – sub 24 de ore.',
    Icon: Clock,
  },
];
      ...
      <div className="container mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div className="mb-10 text-center">
          ...
          <h2 className="text-2xl sm:text-3xl font-bold font-mono text-gray-900">
            Cum Retragi Câștigurile din Bonus
          </h2>
        ...
        <aside className="mt-6 flex items-start gap-3 rounded-xl border border-amber-200 bg-amber-50 p-4">
          ...
          <p className="text-sm text-gray-700 leading-relaxed">
            <strong className="text-amber-800">Important:</strong> Bonusurile fără depunere au un{' '}
            <strong>plafon maxim de retragere</strong> (frecvent 50–100€). Sumele care depășesc acest plafon
