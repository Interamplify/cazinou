...
const pros = [
  'Niciun risc financiar — joci fără să depui',
  'Posibilitatea de a testa o platformă nouă',
  'Câștiguri reale posibile din bani gratis',
  'Ideal pentru a descoperi jocuri Pragmatic Play, NetEnt, Play\'n GO',
  'Disponibil la mai multe cazinouri internaționale',
];

const cons = [
  'Plafon maxim de câștig limitat (50–100€)',
  'Condiții obligatorii de rulaj (30x–50x)',
  'Nu toate jocurile contribuie la rulaj',
      ...
      <div className="container mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        ...
        <div className="mt-6 rounded-xl border border-gray-200 bg-gray-50 p-5 text-center">
          <p className="text-sm text-gray-700 leading-relaxed max-w-3xl mx-auto">
            <strong className="text-gray-900">Verdictul nostru:</strong> Bonusurile fără depunere
            sunt ideale pentru a testa o platformă fără risc. Dacă experiența e satisfăcătoare,
            bonusul de bun venit cu depunere oferă valoare semnificativ mai mare.
          </p>
        </div>
      </div>
    </section>
