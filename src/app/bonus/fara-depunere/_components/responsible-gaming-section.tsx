          ...
          <div className="flex gap-4">
            ...
            <div className="flex-1 space-y-3">
              ...
              <p className="text-sm lg:text-base text-gray-700 leading-relaxed">
                Jocurile de noroc sunt destinate exclusiv persoanelor care au împlinit 18 ani. Scopul lor este
                distracția, nu câștigul sigur. Joacă mereu cu măsură și stabilește-ți din timp limitele de
                timp și bani.
              </p>
              <p className="text-sm lg:text-base text-gray-700 leading-relaxed">
