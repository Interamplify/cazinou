        ...
        <div className="grid gap-6 lg:grid-cols-2 mb-8">
          ...
          <div className="rounded-2xl border-2 border-purple-200 bg-white p-6 shadow-sm">
            <div className="flex items-center gap-3 mb-5">
              ...
              <h3 className="font-mono font-bold text-gray-900 text-lg">Bonus Standard</h3>
            </div>

            <div className="rounded-xl bg-purple-50 p-5 text-center mb-5">
              <p className="text-5xl font-extrabold text-purple-600 font-mono">35x</p>
        ...
        <div className="rounded-2xl border border-gray-200 bg-white p-6 shadow-sm mb-6">
          ...
          <div className="grid gap-4 sm:grid-cols-3 text-center">
            ...
            <div className="rounded-xl bg-purple-50 p-4">
              ...
              <p className="text-xl font-bold text-purple-600 font-mono">500 RON</p>
            </div>
