      ...
      <div className="container mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div className="mb-10 text-center">
          ...
          <h2 className="text-2xl sm:text-3xl font-bold font-mono text-gray-900">
            Cerințe de Rulaj și Condiții Bonus GGBet
          </h2>
        ...
        <div className="grid gap-6 lg:grid-cols-2 mb-8">
          ...
          <div className="rounded-2xl border-2 border-orange-200 bg-white p-6 shadow-sm">
            ...
            <div className="rounded-xl bg-orange-50 p-5 text-center mb-5">
              <p className="text-5xl font-extrabold text-orange-600 font-mono">40x</p>
            ...
            <div className="space-y-3">
              <div className="flex items-start gap-2">
                ...
                <span className="text-sm text-gray-700">Rulaj pe suma bonus și rotiri</span>
              </div>
              <div className="flex items-start gap-2">
                <CheckCircle2 className="h-5 w-5 text-green-600 flex-shrink-0 mt-0.5" />
                <span className="text-sm text-gray-700">Pariu maxim 10 RON pe rotire</span>
              </div>
              <div className="flex items-start gap-2">
                <CheckCircle2 className="h-5 w-5 text-green-600 flex-shrink-0 mt-0.5" />
          ...
          <div className="rounded-2xl border-2 border-green-200 bg-white p-6 shadow-sm">
            ...
            <div className="rounded-xl bg-green-50 p-5 text-center mb-5">
              <p className="text-5xl font-extrabold text-green-600 font-mono">40x</p>
            ...
            <div className="space-y-3">
              <div className="flex items-start gap-2">
                <CheckCircle2 className="h-5 w-5 text-green-600 flex-shrink-0 mt-0.5" />
                <span className="text-sm text-gray-700">50 rotiri la Joker Stoker</span>
              </div>
              <div className="flex items-start gap-2">
                <CheckCircle2 className="h-5 w-5 text-green-600 flex-shrink-0 mt-0.5" />
                <span className="text-sm text-gray-700">Pariu maxim 10 RON pe rotire</span>
              ...
              <div className="flex items-start gap-2">
                <CheckCircle2 className="h-5 w-5 text-green-600 flex-shrink-0 mt-0.5" />
                <span className="text-sm text-gray-700">Acceptă notificarea pentru activare</span>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="rounded-2xl border border-gray-200 bg-white p-6 shadow-sm mb-6">
          <h3 className="font-mono font-bold text-gray-900 text-lg mb-4 flex items-center gap-2">
            ...
            Exemplu de Calcul Rulaj (Prima Depunere)
          </h3>
          <div className="grid gap-4 sm:grid-cols-3 text-center">
            <div className="rounded-xl bg-gray-50 p-4">
              <p className="text-xs text-gray-500 uppercase mb-1">Depunere</p>
              <p className="text-xl font-bold text-gray-900 font-mono">1.000 RON</p>
            </div>
            ...
            <div className="rounded-xl bg-green-50 p-4">
              <p className="text-xs text-gray-500 uppercase mb-1">Rulaj necesar (40x)</p>
              <p className="text-xl font-bold text-green-600 font-mono">40.000 RON</p>
            </div>
          </div>
        </div>

        {/* Important warning - 2x Rollover Tax */}
        <div className="rounded-xl border border-red-200 bg-red-50/50 p-5 text-center">
          <div className="flex items-center justify-center gap-2 mb-2">
            <AlertTriangle className="h-5 w-5 text-red-600" />
            <span className="font-mono font-bold text-red-700">Taxă 20% pentru Fonduri Nerulate</span>
          </div>
          <p className="text-sm text-gray-700 leading-relaxed">
            Se aplică o taxă de <strong>20%</strong> la retragere dacă fondurile depuse nu au fost
            rulate de cel puțin <strong>2x</strong>. Exemplu: depui 500 RON, trebuie să pariezi
            minim 1.000 RON pentru a evita taxa.
          </p>
        </div>
      </div>
    </section>
