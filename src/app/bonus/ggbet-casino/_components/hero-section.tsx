import { CalendarDays, TrendingUp, Award, Sparkles, Gamepad2 } from 'lucide-react';
      ...
      <div className="container mx-auto max-w-7xl py-12 sm:py-16 lg:py-20 px-4 sm:px-6 lg:px-8 text-center">
        ...
        <nav aria-label="Breadcrumb" className="mb-6">
          <ol className="flex items-center justify-center gap-1.5 text-sm font-mono text-gray-400">
            ...
            <li>/</li>
            <li className="text-gray-900 font-semibold">GGBet Casino Bonus</li>
          </ol>
        </nav>
        ...
        <h1 className="mb-5 text-3xl font-extrabold tracking-tight text-gray-900 sm:text-4xl lg:text-5xl font-mono leading-[1.1] max-w-4xl mx-auto">
          Bonus <span className="text-orange-500">GGBet Casino</span> 2026
        </h1>

        {/* Intro */}
        <p className="text-base sm:text-lg text-gray-500 leading-relaxed max-w-3xl mx-auto mb-8">
          GGBet Casino oferă 50 de rotiri gratuite fără depunere la înregistrare și un pachet
          de bun venit generos de până la 12.000 RON + 900 rotiri pe primele 7 depuneri. Lider
          în pariuri eSports cu peste 8.000 de jocuri de la aproape 100 de furnizori.
        </p>
        ...
        <div className="flex flex-wrap items-center justify-center gap-3 mb-8">
          ...
          <div className="flex items-center gap-1.5 rounded-full border border-gray-200 bg-white px-3 py-1.5 shadow-sm">
            ...
            <span className="text-xs font-mono font-semibold text-gray-700">12.000 RON + 900 Rotiri</span>
          </div>
          <div className="flex items-center gap-1.5 rounded-full border border-gray-200 bg-white px-3 py-1.5 shadow-sm">
            <Gamepad2 className="h-3.5 w-3.5 text-purple-500" />
            <span className="text-xs font-mono font-semibold text-gray-700">Lider eSports</span>
          </div>
          <div className="flex items-center gap-1.5 rounded-full border border-gray-200 bg-white px-3 py-1.5 shadow-sm">
            <Award className="h-3.5 w-3.5 text-amber-500" />
            <span className="text-xs font-mono font-semibold text-gray-700">8.000+ Jocuri</span>
          </div>
        </div>
