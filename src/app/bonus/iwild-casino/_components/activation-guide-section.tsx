...
const steps = [
  {
    step: 1,
    title: 'Înregistrare',
    desc: 'Creează cont gratuit pe iWild Casino cu email și parolă',
    Icon: UserPlus,
  },
  {
    step: 2,
      ...
      <div className="container mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div className="mb-10 text-center">
          ...
          <h2 className="text-2xl sm:text-3xl font-bold font-mono text-gray-900">
            Cum Activezi Bonusul de 550% la iWild Casino
          </h2>
        ...
        <div className="mb-10 max-w-2xl mx-auto">
          <Image
            src="/images/registrezi-iwild-casino.webp"
            alt="Înregistrare iWild Casino"
            width={800}
            height={450}
