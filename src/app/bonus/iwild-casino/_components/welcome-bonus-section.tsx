import { Gift, Zap, Trophy, Star } from 'lucide-react';

const deposits = [
  {
    number: 1,
    title: 'Prima Depunere',
    bonus: '200% până la 5.000 RON',
    freeSpins: '200 Rotiri pe Sweet Bonanza',
  ...
  },
  {
    ...
    freeSpins: '100 Rotiri pe Sugar Rush',
    minDeposit: '100 RON minim',
    icon: Zap,
  ...
  },
  {
    ...
    bonus: '100% până la 5.000 RON',
    freeSpins: '100 Rotiri pe Dog House',
    minDeposit: '100 RON minim',
    icon: Trophy,
  ...
  {
    number: 4,
    title: 'A Patra Depunere',
    bonus: '150% până la 5.000 RON',
    freeSpins: '150 Rotiri pe Big Bass Bonanza',
    minDeposit: '100 RON minim',
    icon: Star,
      ...
      <div className="container mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div className="mb-10 text-center">
          ...
          <h2 className="text-2xl sm:text-3xl font-bold font-mono text-gray-900">
            Bonus de Bun Venit iWild Casino — 550% + 550 Rotiri pe 4 Depuneri
          </h2>
          <p className="text-base text-gray-500 mt-2 max-w-2xl mx-auto">
            Pachetul complet se desfășoară pe primele patru depuneri,
            oferindu-ți un total de 20.000 RON bonus și 550 rotiri gratuite
            pe sloturi Pragmatic Play populare.
          </p>
        </div>
        ...
        <div className="rounded-2xl border-2 border-orange-500 bg-orange-50/50 p-6 text-center">
          ...
          <p className="text-2xl sm:text-3xl font-bold font-mono text-gray-900">
            20.000 RON <span className="text-orange-500">+</span> 550 Rotiri Gratuite
          </p>
          <p className="text-sm text-gray-600 mt-2 font-mono">
            Distribuit pe primele 4 depuneri • Rulaj 35x • Activare automată
          </p>
        </div>
      </div>
    </section>
