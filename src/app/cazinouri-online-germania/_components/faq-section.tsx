...
import { cazinouriGermaniaFaqs } from '@/data/cazinouri-germania';

export function FaqSection() {
  return (
    <section id="faq" className="py-14 lg:py-20 bg-gray-50/50">
      <div className="container mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div className="mb-8 text-center">
          ...
          <p className="text-base text-gray-500 mt-2 max-w-2xl mx-auto">
            Răspunsuri despre legalitate, licențe GGL, cazinouri VPN și restricțiile din Germania
          </p>
        </div>

        <div className="max-w-2xl mx-auto">
          <Accordion type="single" collapsible className="space-y-3">
            {cazinouriGermaniaFaqs.map((faq, i) => (
              <AccordionItem
                key={i}
                value={`faq-${i}`}
